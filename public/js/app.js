...
__webpack_require__(/*! ./pages/manageDepartments */ "./resources/js/pages/manageDepartments.js");

__webpack_require__(/*! ./pages/manageUsers */ "./resources/js/pages/manageUsers.js");

__webpack_require__(/*! toastr/toastr.js */ "./node_modules/toastr/toastr.js");

__webpack_require__(/*! ./statusHandler */ "./resources/js/statusHandler.js");

/***/ }),

/***/ "./resources/js/pages/manageDepartments.js":
/*!*************************************************!*\
  !*** ./resources/js/pages/manageDepartments.js ***!
  \*************************************************/
/*! no static exports found */
...
$(document).ready(function () {
  ...
  var manageDepartmentsTable = $('#manageDepartmentsTable').DataTable({
    "paging": true,
    "lengthChange": true,
    "searching": true,
    "select": false,
  ...
  var manageDepartmentUsers = $('#manageDepartmentUsers').DataTable({
    "paging": true,
    "lengthChange": true,
    "searching": true,
    "ordering": true,
  ...
  var tbody = $('#manageDepartmentsTable tbody'); // Delete user onclick button
  ...
  tbody.on('click', 'button[name=edit]', function () {
    ...
    if ($('#idInput').val() !== departmentId) {
      var rowData = manageDepartmentsTable.row($(this).parents('tr')).data();
  ...
  $('#updateDepartmentForm').submit(function (event) {
    ...
    $.ajax({
      ...
      error: function error(response) {
        var error = $.map(response.responseJSON.errors, function (value, index) {
          return [value];
        });
        toastr.error(error);
      }
  ...
  tbody.on('click', 'button[name=addUser]', function () {
    ...
    $.get("/admin/departments/" + departmentId + "/users", function (data) {
      $(data[0]).each(function (index, value) {
        var row = manageDepartmentUsers.row('#' + value).select();
      });
  ...
  $('#submitAddUsersToDepartment').on('click', function (e) {
    var departmentId = $('#hiddenAddUsersToDepartmentInput').val();
    var selectedRows = manageDepartmentUsers.rows({
      selected: true
    }).data();
    var form = [];
...
/***/ "./resources/js/pages/manageUsers.js":
/*!*******************************************!*\
  !*** ./resources/js/pages/manageUsers.js ***!
  \*******************************************/
/*! no static exports found */
...
$(document).ready(function () {
  ...
  var manageUserDepartments = $('#manageUserDepartments').DataTable({
    "paging": true,
    "lengthChange": true,
    "searching": true,
    "ordering": true,
  ...
  var tbody = $('#manageUsersTable tbody'); // Edit user onclick button
  ...
  tbody.on('click', 'button[name=addUser]', function () {
    var userId = this.value;
    $('#hiddenAddDepartmentsToUserInput').val(userId); //deselect all rows
  ...
  $('#submitAddDepartmentsToUser').on('click', function (e) {
    var userId = $('#hiddenAddDepartmentsToUserInput').val();
    var selectedRows = manageUserDepartments.rows({
      selected: true
    }).data();
    var form = [];
    selectedRows.each(function (value, index) {
...
__webpack_require__(/*! /home/adam/Pulpit/laravel - projekt/laravel-emd/resources/js/app.js */"./resources/js/app.js");
module.exports = __webpack_require__(/*! /home/adam/Pulpit/laravel - projekt/laravel-emd/resources/sass/app.scss */"./resources/sass/app.scss");
